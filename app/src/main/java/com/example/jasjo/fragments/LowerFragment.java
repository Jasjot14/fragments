...
public class LowerFragment extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    void initViews() {
        ...
        News news1 = new News(R.drawable.ic_launcher_foreground,"Zee News", "http://zeenews.india.com/");
        News news2 = new News(R.drawable.ic_launcher_foreground, "Aaj Tak", "http://zeenews.india.com/");
...
*/
      ...
      adapter = new NewsAdapter(this, R.layout.item_list, newsList);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_lower);
        initViews();
    }
